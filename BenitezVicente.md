...
```
  ...
  <div id="df-f268bd1a-79c0-4308-8d68-270bd5b808f8" class="colab-df-container">
    <div>
<style scoped>
...
<p>5 rows × 35 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-f268bd1a-79c0-4308-8d68-270bd5b808f8')"
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-f268bd1a-79c0-4308-8d68-270bd5b808f8 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-f268bd1a-79c0-4308-8d68-270bd5b808f8');
        const dataTable =
...
<div id="df-0019164f-2880-4380-bd8d-fb95b34f7b6e">
  <button class="colab-df-quickchart" onclick="quickchart('df-0019164f-2880-4380-bd8d-fb95b34f7b6e')"
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-0019164f-2880-4380-bd8d-fb95b34f7b6e button');
...
</style><div id="sk-container-id-1" class="sk-top-container"><div class="sk-text-repr-fallback"><pre>LogisticRegression(max_iter=3500)</pre><b>In a Jupyter environment, please rerun this cell to show the HTML representation or trust the notebook. <br />On GitHub, the HTML representation is unable to render, please try loading this page with nbviewer.org.</b></div><div class="sk-container" hidden><div class="sk-item"><div class="sk-estimator fitted sk-toggleable"><input class="sk-toggleable__control sk-hidden--visually" id="sk-estimator-id-1" type="checkbox" checked><label for="sk-estimator-id-1" class="sk-toggleable__label fitted sk-toggleable__label-arrow fitted">&nbsp;&nbsp;LogisticRegression<a class="sk-estimator-doc-link fitted" rel="noreferrer" target="_blank" href="https://scikit-learn.org/1.5/modules/generated/sklearn.linear_model.LogisticRegression.html">?<span>Documentation for LogisticRegression</span></a><span class="sk-estimator-doc-link fitted">i<span>Fitted</span></span></label><div class="sk-toggleable__content fitted"><pre>LogisticRegression(max_iter=3500)</pre></div> </div></div></div></div>
...
```
  ...
  <div id="df-58e8c587-6047-4b5e-b0db-a67f9b1fdc72" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-58e8c587-6047-4b5e-b0db-a67f9b1fdc72')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-58e8c587-6047-4b5e-b0db-a67f9b1fdc72 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-58e8c587-6047-4b5e-b0db-a67f9b1fdc72');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-74234178-520d-45f6-bc10-892a833d2b80">
  <button class="colab-df-quickchart" onclick="quickchart('df-74234178-520d-45f6-bc10-892a833d2b80')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-74234178-520d-45f6-bc10-892a833d2b80 button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_99f1a88d-79b4-4da5-ad01-c484949025b5">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
    ...
    <button class="colab-df-generate" onclick="generateWithVariable('conf')"
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_99f1a88d-79b4-4da5-ad01-c484949025b5 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      buttonEl.onclick = () => {
        google.colab.notebook.generateWithVariable('conf');
      }
      })();
    </script>
  </div>
...
</style><div id="sk-container-id-4" class="sk-top-container"><div class="sk-text-repr-fallback"><pre>LogisticRegression(max_iter=8000)</pre><b>In a Jupyter environment, please rerun this cell to show the HTML representation or trust the notebook. <br />On GitHub, the HTML representation is unable to render, please try loading this page with nbviewer.org.</b></div><div class="sk-container" hidden><div class="sk-item"><div class="sk-estimator fitted sk-toggleable"><input class="sk-toggleable__control sk-hidden--visually" id="sk-estimator-id-4" type="checkbox" checked><label for="sk-estimator-id-4" class="sk-toggleable__label fitted sk-toggleable__label-arrow fitted">&nbsp;&nbsp;LogisticRegression<a class="sk-estimator-doc-link fitted" rel="noreferrer" target="_blank" href="https://scikit-learn.org/1.5/modules/generated/sklearn.linear_model.LogisticRegression.html">?<span>Documentation for LogisticRegression</span></a><span class="sk-estimator-doc-link fitted">i<span>Fitted</span></span></label><div class="sk-toggleable__content fitted"><pre>LogisticRegression(max_iter=8000)</pre></div> </div></div></div></div>
...
```
  ...
  <div id="df-1538764f-0571-4050-9760-917bdd8f16a1" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-1538764f-0571-4050-9760-917bdd8f16a1')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-1538764f-0571-4050-9760-917bdd8f16a1 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-1538764f-0571-4050-9760-917bdd8f16a1');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-8225494a-4386-4ef3-b973-3c548105e1cc">
  <button class="colab-df-quickchart" onclick="quickchart('df-8225494a-4386-4ef3-b973-3c548105e1cc')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-8225494a-4386-4ef3-b973-3c548105e1cc button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_16ea8659-e24a-44e0-a8b1-d1e00f631a20">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_16ea8659-e24a-44e0-a8b1-d1e00f631a20 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
...
```
  ...
  <div id="df-80fa4a13-496a-4674-815f-5f8e683ecd5d" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-80fa4a13-496a-4674-815f-5f8e683ecd5d')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-80fa4a13-496a-4674-815f-5f8e683ecd5d button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-80fa4a13-496a-4674-815f-5f8e683ecd5d');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-e1a568b4-14ba-4e43-85f3-f46478fa60bd">
  <button class="colab-df-quickchart" onclick="quickchart('df-e1a568b4-14ba-4e43-85f3-f46478fa60bd')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-e1a568b4-14ba-4e43-85f3-f46478fa60bd button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_879c478c-859c-4592-9209-b85474b37d2d">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_879c478c-859c-4592-9209-b85474b37d2d button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
